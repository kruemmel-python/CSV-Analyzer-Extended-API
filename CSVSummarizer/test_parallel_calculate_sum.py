...
class TestParallelCalculateSum(unittest.TestCase):
    def setUp(self):
    ...
    def test_parallel_calculate_sum(self):
        col = self.header[7]  # PLZ as an example
        total_sum = self.summarizer.parallel_calculate_sum(col)
        print(f"Parallel Sum of '{col}': {total_sum}")
